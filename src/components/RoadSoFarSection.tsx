              ...
              <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="relative shrink-0 lg:ml-8 lg:mr-4">
                  ...
                  <div className="invisible pointer-events-none opacity-0">
                    <div className="flex w-[240px] items-center justify-center rounded-full border px-4 py-3 sm:w-[260px] sm:px-8 sm:py-4">
                  ...
                  <motion.div
                    ...
                    className={`z-[100] flex flex-col overflow-hidden transition-colors duration-300 ${isExpanded
                      ? 'fixed inset-0 m-auto h-fit w-[calc(100vw-32px)] max-h-[85vh] overflow-y-auto max-w-2xl cursor-default rounded-[30px] skills-glass-panel p-6 sm:p-8 lg:absolute lg:inset-auto lg:bottom-0 lg:right-0 lg:overflow-hidden lg:origin-bottom-right lg:p-10 lg:w-[480px] xl:w-[540px]'
                      : 'absolute left-0 bottom-0 origin-bottom-left lg:left-auto lg:right-0 lg:origin-bottom-right w-[240px] h-[48px] cursor-pointer items-center justify-center rounded-full skills-glass-pill bg-black/[0.04] px-4 py-3 hover:bg-black/[0.06] sm:w-[260px] sm:px-8 sm:py-4'
                      }`}
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-black/5 text-lg text-[#0C0C0C]/60 transition-colors hover:bg-black/10 hover:text-[#0C0C0C]"
                      >
                        &times;
                      </button>
